...
grep -B 1 'href="#' Changes/index.html | sed -e 's/^<li>$/<li><font size="-1">/' -e 's/<\/li>$/<\/font><\/li>/' -e 's/href="#/href="Changes\/#/' -e '/^--/d' | sed -e '17,$d' >> index.tmp
...
grep -B1 'href="#' gallery/events.html | sed -e 's/^<li>$/<li><font size="-1">/' -e 's/<\/li>$/<\/font><\/li>/' -e 's/href="#/href="gallery\/events.html#/' -e '/^--/q' | sed -e '/^--/d' -e '13,$d' >> index.tmp
